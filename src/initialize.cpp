...
RetBC Initialize::boundry_condition_fun(bc boundry, GQVandW GQdat, int order)
{
	...
	if (boundry.node1 == (elements[ele].node1 - 1) && boundry.node2 == (elements[ele].node2 - 1))
	{
		condition = 1;
		c1 = 0, c2 = 6;
	}
	else if (boundry.node1 == (elements[ele].node2 - 1) && boundry.node2 == (elements[ele].node3 - 1))
	{
		condition = 2;
		c1 = 6, c2 = 12;
	}
	else if (boundry.node1 == (elements[ele].node3 - 1) && boundry.node2 == (elements[ele].node4 - 1))
	{
		condition = 3;
		c1 = 12, c2 = 18;
	}
	else if (boundry.node1 == (elements[ele].node4 - 1) && boundry.node2 == (elements[ele].node1 - 1))
	{
		condition = 4;
		c1 = 18, c2 = 0;
	}
